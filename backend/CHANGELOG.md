...
### Added
- Expanded Gordian backend-relevant QA coverage for supplier email/attachment ingestion, quote-data validation, malformed inputs, multi-supplier/multi-product RFQs, and product-matching scenarios.
- Added FastAPI to backend technology coverage.
